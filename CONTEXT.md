...
| **Translation-mapping draft** | The Operator's editable, unsaved set of Translation mappings. It preserves row identity and user-entered values while editing, reports incomplete or invalid rows, and projects valid content into a Session creation or Mapping revision update. It is not itself a Mapping revision until saved. |
